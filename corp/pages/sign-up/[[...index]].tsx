    ...
    <div className={`w-full flex h-screen items-center justify-between  ${inter.className}`}>
      <div className="w-1/2 h-full flex  justify-center items-end  ">
          <div className=" flex justify-center items-end  flex-col w-full h-full bg-gradient-to-r from-indigo-500 to-blue-500 p-12">
            <h1 className={`text-[2.5rem] mb-8 text-white font-bold ${source_serif.className}`}>Your professional writing journey start here</h1>
            <h1 className="text-md text-white mb-16 "> Realize your professional aspirations by harnessing the power of cutting-edge AI technology</h1>
