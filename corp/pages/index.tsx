...
<main className={`flex w-full min-h-screen bg-blue-50 flex-col p-0  ${inter.className}`}>
  ...
  <div className="bg-[#5a55b9] h-[100vh]">
      ...
      <div className="w-full h-full flex justify-center items-center relative overflow-hidden">
          ...
          <div className="flex flex-col items-center">
              <h3 className={`text-3xl font-normal text-center mb-4  ${source_serif.className}`}>Sick of spending endless hours crafting professional communications?</h3>
              <div className="text-center mt-8">
                <a href="/sign-in" className="px-6 py-2 rounded-full text-md font-medium text-white  bg-blue-500 hover:bg-blue-700">Elevate your corporate journey with our AI assistant</a>
              </div>
          </div>
